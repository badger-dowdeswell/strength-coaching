        ...
        <div>
            <div>
                <section>
                    ...
                    <TopNav title="My progress" userID = {userID} userImage = {userImage}
                    ...
                    <div className="flex flex-col absolute top-24 bottom-0
                        ...
                        <p className="ml-1 mt-3 text-white">This is the page where the client can view their progress.</p>

                        <br></br>

                        <p className="ml-1 text-white">
                            Progress and training history is displayed here ... and here
                        </p>
                        <br></br>
                    </div>
                </section>
